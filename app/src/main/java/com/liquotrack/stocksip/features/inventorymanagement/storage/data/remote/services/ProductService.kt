...
interface ProductService {
    ...
    suspend fun getAllProductsByAccountId(@Path("accountId") accountId: String): List<ProductDto>
    ...
    suspend fun registerProduct(@Path("accountId") accountId: String, product: ProductDto): ProductDto
    ...
    suspend fun updateProduct(@Path("productId") productId: String, product: ProductDto): ProductDto
    ...
    suspend fun updateProductMinimumStock(@Path("productId") productId: String, minimumStock: Int): ProductDto
